      ...
      <Dialog.Portal>
        ...
        <Dialog.Content asChild>
          <motion.div
            ...
            className="fixed top-16 left-1/2 z-[1001] w-full max-w-md -translate-x-1/2 rounded-2xl bg-gradient-to-br from-[#101c13] via-[#0F0F15] to-[#1a2e1a] p-0 shadow-2xl border border-[#75BE40]/30 overflow-hidden"
            style={{ maxHeight: '90vh' }}
          >
            <Dialog.Close asChild>
              <button className="absolute top-3 right-3 text-white/70 hover:text-white transition-colors rounded-full p-1.5 bg-black/20 z-20">
                <X className="w-5 h-5" />
              </button>
            </Dialog.Close>
            ...
            <div className="flex flex-col h-full overflow-y-auto p-5 scrollbar-thin scrollbar-thumb-[#75BE40]/40 scrollbar-track-transparent relative z-10">
